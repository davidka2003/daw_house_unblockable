...
import logo_black from "../assets/logo_black_thin.jpg";
import styled from "styled-components";
import { motion } from "framer-motion";
const StyledSnapChat = styled.div`
  width: 65%;
  padding: 40px 80px;
  max-height: 400px;
  border-radius: 5px;
...
const SnapChat = ({
  ...
  return (
    <StyledSnapChat className="card">
      <CardRow>
        <div style={{ borderRight: "solid 1px white" }}>
      ...
      <h1>Wear your shoe on SnapChat.</h1>
