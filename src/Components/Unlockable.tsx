...
const Unlockable = () => {
  ...
  const [content, setContent] = useState<{ type: "DAW" | "HOUSE"; content_type: "link" | "code"; content: string }[]>(
    []
  );
    ...
    <>
      <div className="header">
        ...
        <div className="header__links">
          ...
          <div className="">
            <a href="https://desperateapewives.com/house-of-daw/">HOUSE OF DAW</a>
          </div>
          <div className="">
          ...
          <div className="header__socialNetwork--container">
            <div className="header__socialNetwork--container--links">
              <a href="https://opensea.io/collection/desperate-ape-wives">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 90 90" fill="none">
                  <path
